...
describe('Auth Routes', () => {
    ...
    describe('POST /register', () => {
        it('Berhasil mendaftarkan user baru', async () => {
            ...
            jest.spyOn(User.prototype, 'save').mockResolvedValueOnce({ email: 'test@example.com', username: 'testuser' });
        ...
        it('Gagal mendaftar jika email sudah terdaftar', async () => {
            ...
            expect(response.body.errors[0]).toHaveProperty('msg', 'Email already registered');
        });
        ...
        it('Gagal mendaftar jika email tidak valid', async () => {
            ...
            expect(response.body.errors[0]).toHaveProperty('msg', 'Please enter a valid email');
        });
    ...
    describe('POST /login', () => {
        it('Berhasil login dengan kredensial valid', async () => {
            ...
            expect(jwt.sign).toHaveBeenCalledWith({ id: 'userId' }, 'dealls-dating-2024', {
                expiresIn: '1d',
            });
        });
